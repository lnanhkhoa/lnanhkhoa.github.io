...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className="py-20 px-6 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800"
    >
                ...
                <div className="p-6">
                  {company.roles.map((role, roleIndex) => (
                    ...
                    >
                      ...
                      {/* Achievements */}
                      <div className="mb-4">
                        <h5 className="font-medium text-slate-900 dark:text-slate-100 mb-3 flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {role.technologies.map((tech, i) => (
                            <span
                              key={i}
                              className="px-3 py-1 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900 dark:to-purple-900 text-blue-700 dark:text-blue-300 rounded-full text-sm font-medium border border-blue-200 dark:border-blue-700 hover:shadow-sm transition-shadow"
                            >
                              {tech}
                            </span>
                          ))}
