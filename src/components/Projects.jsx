...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      company: 'Bitis',
      description:
        "The Biti's Loyalty Mobile App was designed to enhance customer engagement and brand loyalty by providing users with rewards, coupon and promotional campaigns. The app allowed users to track purchases, earn points, and redeem rewards in special holiday both in-store and online.",
      image: '/api/placeholder/400/250',
  ...
  return (
    <section id="projects" className="p-6 bg-muted/30">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300"
              >
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-slate-500">{project.teamSize}</div>
                    </div>
                  </div>
